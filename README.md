...
Algunas decisiones clave tomadas durante el desarrollo, con sus tradeoffs explícitos:

| Tema          | Alternativas descartadas  | Decisión                    | Tradeoff y justificación                                                                                                                                                                         |
| ------------- | ------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Stack         | RN bare                   | **Expo**                    | Expo acelera el setup, manejo de assets y builds, permitiendo enfocarse en producto y arquitectura. **Tradeoff:** menor control fino del layer nativo, aceptable para el alcance del desarrollo. |
